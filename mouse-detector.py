...
#         if cv2.contourArea(c) < min_area and count == 0:
#             continue
...
# firstFrame = None
# min_area = 50  # Minimum area size for motion detection
...
# count = 5
# upload_interval = 5  # Adjust the interval for when to upload
...
firstFrame = None
min_area = 20  # Minimum area size for motion detection
